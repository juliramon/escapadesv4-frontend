...
const Registre = () => {
		...
		<>
			<div className="funnel-steps-wrapper">
				<ul>
					<li
						className={
							state.step === "seleccio-pla" ? "active" : null
						}
					>
						Pas 1
					</li>
					...
					<li
						className={
							state.step === "publicar-fitxa" ? "active" : null
						}
					>
						Pas 4
					</li>
						...
						<div className="page-header-wrapper">
							<div className="col-left">
								...
								<p className="page-header-subtitle">
									Entra la informació bàsica de la teva
									empresa{" "}
								</p>
								{errorMessage}
											...
											<div className="form-group-right">
												...
												<Form.Group>
													...
													<Autocomplete
														...
														types={["address"]}
														placeholder={
															"Escriu la direcció de facturació"
														}
														fields={[
															"address_components",
															"formatted_address",
						...
						<div className="page-header-wrapper">
							...
							<div className="bottom">
								<div className="cards-wrapper">
									<div
										className="card"
										onClick={handleActivityForm}
									>
										<h2 className="page-header-subtitle">
											Activitats
										</h2>
										<p>
											Selecciona aquesta opció si la teva
											empresa es dedica a organitzar
											activitats en interiors o a l'aire
											lliure.
										</p>
									...
									>
										...
										<p>
											Selecciona aquesta opció si la teva
											empresa es dedica a gestionar un
											allotjament o un establiment.
										</p>
										<button className="btn btn-l btn-blue">
	...
	return (
		<>
			<GlobalMetas
				title="Crea el teu compte d'empresa"
				description="Crea el teu compte d'empresa gratuït en qüestió de minuts a Escapadesenparella.cat."
				url="https://escapadesenparella.cat/empreses/registre"
				image="https://res.cloudinary.com/juligoodie/image/upload/v1652527292/getaways-guru/IMGP9489-s_izgty6.jpg"
				canonical="https://escapadesenparella.cat/empreses/registre"
			/>
