			...
			<div id="contentList" className="activity relative">
				...
				<main>
					...
					<section className="pb-8 md:pb-16">
						<div className="container">
							<div className="w-full flex flex-wrap items-center justify-between pt-8 pb-2">
								...
								<div className="w-full md:w-1/2 flex justify-end">
									<div className="w-11/12">
										<div className="relative z-30 w-full">
											<div className="rounded-lg bg-red-100 px-8 py-20 flex flex-wrap items-center justify-center">
												...
												<span class="w-full block font-bold text-xl text-center">
													Banner als llistats d'escapades
													<br /> (activitats i allotjaments)
												</span>
											</div>
