						...
						if (userBookmarks) {
							userBookmarks.forEach((el) => {
								if (
									...
									el.bookmarkActivityRef._id === getawayDetails._id
								) {
															...
															<div className="pb-6 flex items-start">
																...
																<div className="pl-4">
																	...
																	<p className="text-sm mb-0 opacity-70">
																		...
																		recomanades a Escapadesenparella.cat estan
																		pensades per a que les parelles gaudeixin al
																		màxim de les seves escapades.
																	</p>
																</div>
															</div>
															<div className="pb-6 flex items-start">
					...
					const fetchData = async () => {
						...
						if (userBookmarks) {
							userBookmarks.forEach((el) => {
								if (
									el.bookmarkPlaceRef &&
									el.bookmarkPlaceRef._id === getawayDetails._id
								) {
									return (bookmarkDetails = el);
								}
							});
