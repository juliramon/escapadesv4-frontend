            ...
            <div class="container">
              <div className="flex flex-wrap justify-between items-end relative">
                <div className="w-full md:w-1/2 max-w-md relative z-10 md:pr-4">
                  ...
                  <h1 className="text-white mt-3 font-normal">Llistes</h1>
                  <div className="mt-2.5 text-base text-white">
                    Descobreix llistes d'idees i consells per viure al màxim les
                    vostres escapades en parella per Catalunya
                  </div>
                </div>
