            ...
            <article className="w-full md:w-3/4">
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  present, informa a l’usuari de com tractarà la seva informació
                  personal.
                </p>
              </section>
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  la Llei de Protecció de Dades i els Serveis de la Societat de
                  la Informació, amb la finalitat de:
                </p>
                <ul>
                  <li>
                    Proporcionar a l’usuari accés a la pàgina web i als serveis
                    en línia
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    servei i els continguts d’Escapadesenparella.cat (empreses i
                    individuals)
                  </li>
                  <li>
                    Proporcionar a l’usuari informació comercial i promocional
                    relacionada directament i/o indirectament amb el sector del
                    turisme, restauració, hostaleria i/o altres serveis oferts
                    per Escapadesenparella.cat, principalment per mitjans
                    electrònics (telèfon, correu electrònic i Internet), però
                    també per qualsevol altre mitjà
                  </li>
                </ul>
                <p>
                  La base legal pel tractament de les dades és el consentiment
                  de l’usuari. A aquest efecte, es demana a l’usuari que doni el
                  seu consentiment a aquesta política de privadesa i que accepti
                  les condicions generals. La no acceptació d’aquesta política
                  de privadesa implicarà que els serveis prestats i els
                  continguts del lloc web oferts per Escapadesenparella.cat no
                  estaran disponibles i que s’interromprà el procés de
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  Escapadesenparella.cat és certa i és responsable de notificar
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  contingut. L’objectiu d’aquest tractament és l’adequació dels
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  Escapadesenparella.cat es reserva el dret de modificar aquesta
                  política per adaptar-la a les noves normatives o
                  jurisprudències i pràctiques industrials i/o comercials.
                </p>
                <p>
                  Si Escapadesenparella.cat decideix canviar la seva política de
                  privadesa, publicarà aquests canvis en la present pàgina.
                </p>
                <p>
                ...
                <p>
                  Escapadesenparella.cat ha adoptat les mesures de seguretat de
                  protecció de dades legalment requerides i s’esforça per
                  instal·lar contínuament mesures i mitjans tècnics addicionals
                  dins del seu àmbit per evitar la pèrdua, l’ús indegut,
                  l’alteració, l’accés no autoritzat i/o el robatori de les
                  dades personals proporcionades. Escapadesenparella.cat es
                  compromet a utilitzar tota la informació enviada pels usuaris
                  registrats amb la màxima confidencialitat i professionalitat.
                </p>
                <p>
                  Escapadesenparella.cat emmagatzemarà les dades personals fins
                  que les dades personals deixin de ser necessàries per a les
                  finalitats per a les quals van ser recopilades o quan
                  l’interessat retiri el consentiment en que es basa el
                  tractament de les mateixes. No s’aplicaran i les dades
                  personals es conservaran emmagatzemades quan aquest tractament
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  Escapadesenparella.cat garanteix que, en cap casa, notificarà
                  ni cedirà aquestes dades a tercers, tret que ho autoritzin
                  expressament els usuaris. Les dades es podrien comunicar als
                  tercers destinataris següents:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    destinataris ubicats a tercers països i amb els quals s’han
                    formalitzat les clàusules contractuals estàndard sobre
                    protecció de dades adoptades per la Comissió Europea
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  adjuntant una còpia del seu document nacional d’identitat o un
                  altre document d’identitat equivalent. Els usuaris tenen dret
                  a retirar el consentiment en qualsevol moment, sense afectar
                  la licitud del tractament basa en el consentiment abans de la
                  seva retirada. Els usuaris també tenen dret a presentar una
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  efecte a la primera visita a aquest lloc web. Tot i que no sol
                  aparèixer en visites posteriors, podeu retirar el vostre
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  . Escapadesenparella.cat reconeix aquestes cookies en visites
                  posteriors perquè permeten al nostre sistema recordar
                ...
                <ul>
                  <li>
                    <b>Cookies de primers i tercers:</b> Si una cookie és pròpia
                    o de tercers, es fa referència al domini que col·loca la
                    cookie. Les cookies pròpies són les que estableix un lloc
                    web que l’usuari visita. Les cookies de tercers són cookies
                    establertes per un domini diferent del del lloc web que
                    l’usuari visita. Si un usuari visita un lloc web i una altra
                    entitat estableix una cookie a través d’aquest lloc web,
                    aquesta seria una cookie de tercers.
                    <br />
                    <br />
                  ...
                  <li>
                    ...
                    comença quan l’usuari obre la finestra del navegador i acaba
                    quan tanca la finestra del navegador. Les cookies de sessió
                    es creen temporalment. Un cop l’usuari tanqui el navegador,
                    totes les cookies de sessió es suprimiran automàticament.
                  </li>
                </ul>
              </section>
              <section className="legal-terms__block">
                ...
                <p>
                  Si l’usuari vol eliminar les cookies que hi ha al seu equip o
                  dispositiu, haurà de consulta les instruccions del seu
                  programari de gestió de fitxers per localitzar el fitxer o el
                  director que emmagatzem ales cookies.
                </p>
                <p>
                  Si l’usuari no està d’acord amb l’ús d’aquestes cookies,
                  Escapadesenparella.cat recomana desactivar-les consultant les
                  instruccions del fabricant del navegador fent clic a “Ajuda”
                  al menú del navegador. L’usuari haurà de tenir en compte que
                  en suprimir les cookies d’Escapadesenparella.cat o inhabilitar
                  les cookies futures, és possible que no pugui accedir a
                  determinades àrees o funcionals del nostre lloc web.
                </p>
                <p>
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  ...
                  pertanyen a totes les categories que s’indiquen a continuació:
                </p>
                <ul>
                  <li>
              ...
              <section className="legal-terms__block">
                ...
                <p>
                  L’usuari ha de tenir en compte que aquesta política de cookies
                  no s’aplica, i Escapadesenparella.cat no es responsabilitza,
                  de les pràctiques de privadesa de llocs web de tercers que
                  poden estar enllaçats amb aquest lloc web.
                </p>
                <p>
                  Finalment, Escapadesenparella.cat recomana a l’usuari visitar
                  també la nostra secció de Termes i Condicions d’Ús que regula
                  l’ús del nostre lloc web.
                </p>
              </section>
            </article>
          </div>
