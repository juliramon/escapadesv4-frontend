								...
								<div className="aspect-w-4 aspect-h-3 h-full w-full ">
									<picture>
										<img
											src={image}
											alt={figCaption}
											className="w-full h-full object-cover object-bottom scale-100 transition-all duration-300 ease-in-out group-hover:scale-105"
											width={400}
											height={300}
											loading="eager"
										/>
