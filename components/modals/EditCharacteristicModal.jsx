...
const EditCharacteristicModal = ({
	...
	const submitCharacteristic = async () => {
		...
		let characteristicIllustration,
			characteristicImage,
			characteristicSponsorLogo;
		cloudIllustration !== ""
			? (characteristicIllustration = cloudIllustration)
			: (characteristicIllustration = illustration);
		cloudImage !== ""
			? (characteristicImage = cloudImage)
			: (characteristicImage = image);
		cloudSponsorLogo !== ""
			? (characteristicSponsorLogo = cloudSponsorLogo)
			: (characteristicSponsorLogo = sponsorLogo);
		service
			.editCharacteristic(
				id,
				slug,
	...
	useEffect(() => {
		if (characteristic.isSubmitable) {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		if (
			characteristic.updatedIllustration ||
			characteristic.updatedImage ||
			characteristic.updatedSponsorLogo
		) {
			handleFileUpload();
		} else {
			submitCharacteristic();
		...
		<div className={`modal ${visibility == true ? "active" : ""}`}>
			<div className="modal__wrapper">
				<div className="modal__header">
					<span>Edita la característica</span>
					<button
						onClick={() => hideModal()}
