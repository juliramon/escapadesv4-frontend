        ...
        <div className="w-full flex flex-wrap items-start">
          ...
          <div className="w-full md:w-1/2 lg:w-3/12 mb-6 lg:mb-0">
            <div className="footer-content">
              <span className="footer-header text-xl mb-4">Continguts</span>
          ...
          <div className="w-full md:w-1/2 lg:w-3/12 mb-6 lg:mb-0 ">
            <div className="footer-about">
              <span className="footer-header text-xl mb-4">Nosaltres</span>
              <ul className="list-none m-0 p-0">
                <li className="py-1 text-sm leading-tight">
          ...
          <div className="w-full md:w-1/2 lg:w-2/12">
            <div className="footer-connect">
              <span className="footer-header text-xl mb-4">Contacta'ns</span>
              <ul className="list-none m-0 p-0">
                <li className="py-1 text-sm leading-tight">
                  <a
