...
const NavigationBar = ({ logo_url, path }) => {
	...
	return (
		<header className="z-50 bg-white w-full sticky top-0 shadow-sm">
							...
							>
								...
								>
									<g
										...
										fillRule="nonzero"
									>
										<g id="Group" transform="translate(236.000000, 124.000000)">
											<path
						...
						<div className="hidden lg:flex flex-wrap items-center">
							<Link href="/activitats">
								<a className="flex items-center menu__item">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="icon icon-tabler icon-tabler-route text-primary-500 mr-1.5"
										width="22"
										height="22"
										viewBox="0 0 24 24"
										strokeWidth="1.5"
							...
							<Link href="/histories">
								<a className="flex items-center menu__item">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="icon icon-tabler icon-tabler-notebook text-primary-500 mr-1.5"
										width="22"
										height="22"
										viewBox="0 0 24 24"
										strokeWidth="1.5"
							...
							<Link href="/llistes">
								<a className="flex items-center menu__item">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										className="icon icon-tabler icon-tabler-layout-list text-primary-500 mr-1.5"
										width="22"
										height="22"
										viewBox="0 0 24 24"
										strokeWidth="1.5"
