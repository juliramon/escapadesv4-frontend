...
const ShareBarModal = ({
	...
	return (
		<>
			<button
				className={`${
					colorClass ? colorClass : "text-grey-700"
				} inline-flex items-center underline underline-offset-2`}
				onClick={handleShareModalVisibility}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					className="mr-1.5 currentColor"
					width={18}
					height={18}
					viewBox="0 0 24 24"
					strokeWidth={1.5}
			...
			<div className={`modal ${modalOpen ? "active" : ""}`}>
				<div className="modal__wrapper modal--md h-fit">
					<div className="modal__container">
						...
						<div className="modal__body pt-0 h-fit">
							<div className="flex items-center mb-4">
								{picture ? (
									<picture className="block mr-3 rounded overflow-hidden w-12 h-12 relative">
										<img
											src={picture}
											alt={title}
											className={
								...
								<div className="flex flex-wrap items-center text-sm flex-1">
									...
									{rating ? (
										<div className="mr-2.5 inline-flex items-center">
											<svg
												xmlns="http://www.w3.org/2000/svg"
										...
										>
											{isLastItem ? (
												<button
													...
													className="w-full p-5 border border-primary-100 hover:bg-primary-50 transition-all duration-300 ease-in-out rounded-lg flex items-center relative overflow-hidden"
												>
													<div className="mr-2.5">
														{socialShare.icon}
													</div>
													...
													<span
														role="alert"
														className={`absolute right-5 px-2.5 py-1.5 bg-white rounded-md border border-primary-100 transition-all duration-300 ease-in-out text-xs inline-flex items-center ${
															!copiedLink
																? "-bottom-full"
												...
												<a
													...
													title={socialShare.name}
													className="p-5 border border-primary-100 hover:bg-primary-50 transition-all duration-300 ease-in-out rounded-lg flex items-center"
													target="_blank"
